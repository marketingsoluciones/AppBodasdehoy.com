...
export const TableBudgetV8: FC<props> = ({ data }) => {
  const initialColumnVisibility: ColumnVisibility[] = [
    ...
    { accessor: "cantidad", header: t("cantidad"), size: 70, },
    { accessor: "nombre", header: t("item"), size: 180, },
    { accessor: "valor_unitario", header: t("valor unitario"), size: 70, },
    { accessor: "coste_final", header: t("coste total"), size: 70, },
    { accessor: "coste_estimado", header: t("coste estimado"), size: 70, },
    { accessor: "pagado", header: t("pagado"), size: 70, },
    { accessor: "pendiente_pagar", header: t("pendiente por pagar"), size: 70, },
  ]
                    ...
                    <td
                      ...
                      className={`p-2 flex justify-start items-center text-left *truncate *flex-wrap
                        ${cell.column.id === "categoria" || row.original?.fatherCategoria
                          ...
                          : `${cell.column.id === "gasto" && "bg-[#eaecee] border-l-[1px] border-gray-300"} 
                             ${row.original?.fatherGasto ? `bg-[#eaecee] border-b-[1px] border-gray-300 ${!["unidad", "cantidad", "nombre", "valor_unitario"].includes(cell.column.id) && "border-l-[1px] border-gray-300"}` : `bg-white border-l-[1px] border-gray-300 ${cell.column.id !== "gasto" && "border-b-[1px]"}`} 
