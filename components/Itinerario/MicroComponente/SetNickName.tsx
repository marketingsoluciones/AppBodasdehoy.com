    ...
    return (
        <div className="flex flex-col space-y-2 w-full">
            ...
            <div className="flex justify-end items-center space-x-2">
                ...
                }} className="capitalize text-xs rounded-md bg-gray-400 p-1  text-white">
                    cancelar
                </button>
                <button onClick={() => {
                    setNicknameUnregistered(value)
                    setShowModalNickname(false)
                }} className="capitalize text-xs  rounded-md bg-primary p-1 text-white">
                    guardar
                </button>
            </div>
