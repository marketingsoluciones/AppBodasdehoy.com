    ...
    <div className="*bg-emerald-500 flex justify-end flex-1">
      <div className="*bg-blue-300 inline-flex gap-1 items-end text-gray-500">
        {optionsItineraryButtonBox.map((elem, idx) =>
          ...
          }} className={`bg-gray-200 w-10 h-10 rounded-full flex justify-center items-center cursor-pointer ${!isAllowed() ? "text-gray-400" : "hover:bg-gray-300 text-gray-600 hover:text-gray-700"} `}>
            {elem.icon}
          </div>
        )}
      </div>
