  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col gap-4 md:grid md:grid-cols-6 md:my-2 py-1 md:border-b-4 md:border-primary relative">
        ...
        <div className="bg-white rounded-xl col-span-3 shadow-lg flex md:items-center pb-1 md:pb-0 w-3/4. md:w-full h-[88px] md:h-auto relative justify-between px-8 md:px-4">
