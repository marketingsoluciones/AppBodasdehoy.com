                                ...
                                <div className="flex flex-col space-y-1 mb-5 md:mb-0 flex-1">
                                    ...
                                    <div className="border border-gray-300 rounded-xl section overflow-y-auto flex-1 py-1">
                                        {event?.detalles_compartidos_array?.map((item, idx) => {
                                            return (
                                                <div key={idx}>
                                                    <div className={`${itinerario.viewers.includes(item.uid) && "bg-gray-100"} w-full flex items-center py-1 px-2 space-x-2 text-xs text-gray-700`}>
                                                        ...
                                                        <div className="bg-gray-200* w-9 h-9 rounded-full* flex items-center justify-center" onClick={() => { handleAddUser(item) }} >
