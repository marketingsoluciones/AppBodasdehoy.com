...
export const ModalTaskList = ({ setModal, event, categoria, gasto, setEvent }) => {
    ...
    console.log("arraytask",event.presupuesto_objeto.categorias_array[f1].gastos_array[f2].linkTask)
    ...
    return (
        <div className="w-[400px] bg-white rounded-xl shadow-md absolute z-50 right-6 ">
            <div className="flex items-center justify-between border-b border-gray-300 pb-2 p-4">
                <h2 className="text-lg font-semibold capitalize text-gray-700">Enlazar Task</h2>
            ...
            <div className=" mx-2 ">
                Task Link
                <div className="bg-gray-100 mx-3 my-2 p-2 rounded-md h-9 overflow-y-auto flex items-center justify-between ">
                    {
                        (gasto?.linkTask != null) ?
                            <>
