...
const ComprasComp: FC<propsComprasComp> = ({componentState, setComponentState}) => {
  return (
    <div className="w-[100%] h-[100vh] pt[20px] [filter:blur(0px)] flex flex-col items-start justify-start gap-[21px] tracking-[normal] leading-[normal] mq450:max-w-full mq725:max-w-full mq975:max-w-full mq1000:max-w-full">
      ...
      <section className="w-full flex flex-row items-start justify-start py-0 px-[262px] box-border max-w-[1024px] text-center text-sm text-gray-600 mq450:pl-5 mq450:pr-5 mq450:box-border mq450:max-w-full mq725:pl-[131px] mq725:pr-[131px] mq725:box-border mq725:max-w-full mq975:max-w-full mq1000:max-w-full">
        <div className="flex-1 rounded-md box-border flex flex-col items-start justify-start pt-5 px-[21px] pb-6 gap-[10.8px] max-w-[500px] border-[1px] border-solid border-slate-200 mq725:max-w-full">
          <div className="self-stretch flex flex-row items-start justify-center text-mid-5 text-wwwfourvenuescom-santas-gray">
          ...
          <div className="self-stretch flex flex-row items-start justify-start py-0 px-12 box-border max-w-full mq450:pl-6 mq450:pr-6 mq450:box-border">
            <div className="flex-1 flex flex-col items-end justify-start gap-[3px] max-w-full">
              ...
              <div className="self-stretch flex flex-row items-start justify-center py-0 pr-5 pl-[22px]">
                <button className="cursor-pointer [border:none] py-0 px-2.5 bg-color-base rounded-6xs flex flex-row items-end justify-start gap-[10.9px]">
                  ...
                  <div className="relative text-sm leading-[36px] font-medium font-wwwfourvenuescom-inter-regular-123 text-profourvenuescom-nero text-center inline-block min-w-[111px]">
                    Recuperar ticket
                  </div>
                </button>
              </div>
          ...
          <div className="self-stretch flex flex-col items-center justify-start">
            ...
            <div className="rounded-6xs bg-color-base flex flex-row items-center justify-start py-0 px-2.5 gap-[10.9px] z-[1] mt-[-0.5px] text-profourvenuescom-nero">
              ...
              <div className="relative leading-[36px] font-medium whitespace-nowrap">
