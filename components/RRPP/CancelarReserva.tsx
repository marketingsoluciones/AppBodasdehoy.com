      ...
      <div className="md:flex-1 flex flex-col items-center justify-center md:max-w-[700px] ">
        ...
        <div className="self-stretch  flex flex-row items-start justify-start pt-0 px-0 pb-[21px] box-border min-h-[521px] max-w-full text-sm text-black ">
          <div className="md:flex-1 rounded-md bg-white shadow-[0px_1px_10px_rgba(0,_0,_0,_0.12),_0px_4px_5px_rgba(0,_0,_0,_0.14),_0px_2px_4px_-1px_rgba(0,_0,_0,_0.2)] overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[10.5px] box-border gap-[24.5px] md:min-h-[500px] md:max-w-full">
            ...
            />
            <div className="self-stretch flex flex-col md:items-start items-center justify-start gap-[28px] max-w-full">
              <div className="self-stretch flex flex-col items-start justify-start gap-[17.5px] max-w-full">
                <div className="self-stretch flex flex-col items-start justify-start py-3.5 px-0">
                  <div className="self-stretch flex flex-col md:items-start items-center justify-start py-[10.5px] md:pr-[534.2999999999993px] pl-[10.5px] mq450:pr-5 mq450:box-border">
                    <div className="flex flex-row items-center justify-start gap-[10.229999542236328px]">
                      ...
                      <div className="relative text-sm leading-[21px] font-light ">
                        29 Sab. Junio 2024
                      </div>
                    </div>
              ...
              <div className="md:w-[514.8px] w-auto flex flex-row md:items-start items-center justify-center py-0 px-5 box-border max-w-full">
