  ...
  return (
    <div className="w-full h-max relative">
      ...
      <div className="w-full relative">
        {props?.type === "telefono" &&
          <>
            ...
            <div onClick={() => {
              ...
              setOptions(flags)
            }} className="absolute w-10 h-10 flex justify-start items-center cursor-pointer">
        ...
        {props?.type !== "tel"
          ? <input id={props?.type} autoFocus={props?.type === "telefono"} disabled={!isAllowed() || disabled} className={`${props?.type === "telefono" && "pl-11"} font-display text-sm text-gray-500 border-[1px] ${(props?.type !== "tel" ? true : meta.touched) && meta.error ? "border-rose-300" : "border-gray-200"} focus:border-gray-400 w-full py-2 px-4 rounded-xl focus:ring-0 focus:outline-none transition ${className}`} {...field} {...props} type={props?.type === "telefono" ? "tel" : "text"}></input>
