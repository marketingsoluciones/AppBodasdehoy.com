  ...
  return (
    <div className="w-full h-max relative">
      ...
      <div className="w-full">
        <input className={`font-display text-sm text-gray-500 border border-gray-300 focus:border-primary w-full py-2 px-4 rounded-xl focus:outline-none transition ${className}`} {...field} {...props}></input>
      </div>
