...
// ✅ OPTIMIZACIÓN: Lazy loading de KnowledgeBaseList
const KnowledgeBaseList = dynamic(() => import('../../components/KnowledgeBaseList'), {
  loading: () => <div style={{ padding: 16 }}>Cargando bases de conocimiento...</div>,
  ssr: false,
});
