...
// ✅ Cambiar a force-dynamic para evitar errores durante build
// El error "a.includes is not a function" ocurre cuando Next.js intenta
// generar el sitemap estáticamente y el parámetro id no es un string válido
