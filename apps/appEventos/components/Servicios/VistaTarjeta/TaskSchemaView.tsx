...
export const TaskSchemaView: FC<TaskSchemaViewProps> = ({ task, canEdit, ht, handleUpdate, ...props }) => {
  ...
  // La visibilidad para espectadores la resuelve PermissionTaskActionWrapper /
  // canViewTask en el panel. Aquí no filtrar por spectatorView: si no, el dueño
  // ve el esquema vacío para tareas "ocultas a compartidos".
  return (
