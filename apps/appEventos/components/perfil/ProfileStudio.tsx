...
const ProfileStudio: FC = () => {
  ...
  const eye = (on: boolean) => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={on ? "var(--color-primary,#EF5B94)" : "#8a8a90"} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M2 12s3.5-6.5 10-6.5S22 12 22 12s-3.5 6.5-10 6.5S2 12 2 12z" /><circle cx="12" cy="12" r="3" />{!on && <path d="M4 4l16 16" />}</svg>
  );
  const editBtn = (active: boolean): any => ({ padding: "12px 20px", borderRadius: 10, background: active ? "var(--color-primary,#EF5B94)" : "#fff", border: `1.5px solid ${active ? "var(--color-primary,#EF5B94)" : "#E7E7EA"}`, color: active ? "#fff" : "#6b6b72", font: "600 13px Poppins", boxShadow: active ? "0 6px 16px rgba(239,91,148,.3)" : "none", whiteSpace: "nowrap", cursor: "pointer" });

  return (
    <div style={{ width: "100%", maxWidth: 1160, margin: "0 auto", padding: "32px 20px 60px", fontFamily: "'Poppins',sans-serif" }}>
      <style dangerouslySetInnerHTML={{ __html: ".ps-in:focus{border-color:var(--color-primary,#EF5B94)!important;}.ps-pwlbl-m{display:none;}@media (max-width:767px){.ps-grid{grid-template-columns:1fr!important;gap:16px!important;}.ps-acc{grid-template-columns:1fr!important;}.ps-pw{grid-template-columns:1fr!important;align-items:stretch!important;}.ps-pw>button{width:100%!important;}.ps-grid>section,.ps-grid section{padding:22px 20px!important;}.ps-pwlbl-d{display:none!important;}.ps-pwlbl-m{display:inline!important;}}" }} />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "340px 1fr", gap: 24, alignItems: "start" }} className="ps-grid">
        ...
        <section style={{ background: "#fff", border: "1px solid #ececef", borderRadius: 16, padding: "32px 26px", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
          <div style={{ position: "relative", marginBottom: 18 }}>
            <div style={{ width: 116, height: 116, borderRadius: "50%", background: "var(--color-primary,#EF5B94)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", font: "800 42px Poppins", boxShadow: "0 10px 26px rgba(239,91,148,.28)", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 16, flexWrap: "wrap", justifyContent: "center" }}>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "7px 14px", borderRadius: 999, background: "#FCE7F0", font: "600 12px Poppins", color: "var(--color-primary,#EF5B94)" }}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary,#EF5B94)" strokeWidth={2.4} strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l2.4 4.9 5.4.8-3.9 3.8.9 5.4L12 14.3 7.2 16.9l.9-5.4L4.2 7.7l5.4-.8Z" /></svg>{rol}</span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <section style={{ background: "#fff", border: "1px solid #ececef", borderRadius: 16, padding: "28px 30px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
              <div style={{ width: 38, height: 38, borderRadius: 12, background: "#FCE7F0", display: "flex", alignItems: "center", justifyContent: "center" }}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary,#EF5B94)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="4" /><path d="M4 21c0-4 3.6-6.5 8-6.5s8 2.5 8 6.5" /></svg></div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "18px 20px", marginTop: 20 }} className="ps-acc">
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  <input className="ps-in" value={nameVal} onChange={(e) => setNameVal(e.target.value)} readOnly={!nameEdit} style={{ flex: 1, padding: "12px 16px", borderRadius: 10, background: nameEdit ? "#fff" : "#faf9fb", border: `1.5px solid ${nameEdit ? "var(--color-primary,#EF5B94)" : "#f0f0f2"}`, font: "500 13.5px Poppins", color: "#3A3A42", minWidth: 0, outline: "none" }} />
          ...
          <section style={{ background: "#fff", border: "1px solid #ececef", borderRadius: 16, padding: "28px 30px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr auto", gap: "18px 20px", marginTop: 20, alignItems: "end" }} className="ps-pw">
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", padding: "0 6px 0 16px", borderRadius: 10, background: pwEdit ? "#fff" : "#faf9fb", border: `1.5px solid ${pwEdit ? "var(--color-primary,#EF5B94)" : "#f0f0f2"}` }}>
