...
export const ItineraryTabs: FC<props> = ({ setModalDuplicate, itinerario, setItinerario, setEditTitle, view, setView, handleDeleteItinerario, handleUpdateTitle, title, setTitle, editTitle, selectTask, setSelectTask, orderAndDirection, setOrderAndDirection, allExpanded, onToggleExpandAll }) => {
    ...
    if (isStudio && !isMobile) {
        const verOptions = [
            ...
            // En Tareas la 3ª vista es el TABLERO (kanban, boardView); en Itinerario sigue
            // siendo "Esquema" (schema).
            isTareas
              ? { v: "boardView", label: t("Tablero", { defaultValue: "Tablero" }), icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round"><rect x="3" y="4" width="7" height="16" rx="1.5" /><rect x="14" y="4" width="7" height="10" rx="1.5" /></svg> }
    ...
    if (isStudio && isMobile) {
        ...
        const verOptionsM = [
            ...
            isTareas
              ? { v: "boardView", label: t("Tablero", { defaultValue: "Tablero" }), icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round"><rect x="3" y="4" width="7" height="16" rx="1.5" /><rect x="14" y="4" width="7" height="10" rx="1.5" /></svg> }
