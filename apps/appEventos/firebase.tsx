...
export const developments = [
  ...
  },
  {
    ...
    logoDirectory: <img alt="Vivetuboda" className="hover:opacity-80 transition text-primary w-full h-full object-contain" src="/LogoVivetuboda.png" />,
    headTitle: "Organizador de Eventos",
    theme: {
  ...
  },
  {
    ...
    logoDirectory: <img alt="Champagne Events" className="hover:opacity-80 transition text-primary w-full h-full object-contain" src={`/api/proxy-image?url=${encodeURIComponent('https://i.ibb.co/Nsr8LgX/cropped-Logo-Gray-Champagne-1.png')}`} />,
  ...
  },
  {
    ...
    logoDirectory: <img alt="Annlo Events" className="hover:opacity-80 transition text-primary w-full h-full object-contain" src={`/api/proxy-image?url=${encodeURIComponent('https://i.ibb.co/R6by86b/logotipo-annlo-events.png')}`} />,
  ...
  },
  {
    ...
    logoDirectory: <img alt="Amorcito Corazón" className="hover:opacity-80 transition text-primary w-full h-full object-contain" src={`/api/proxy-image?url=${encodeURIComponent('https://i.ibb.co/L8bTqBf/Amorcito-Corazon2.png')}`} />,
    headTitle: "Planificador de Eventos",
  ...
  },
  {
    ...
    logoDirectory: <img alt="Eventos Integrados" className="hover:opacity-80 transition text-primary w-full h-full object-contain" src={`/api/proxy-image?url=${encodeURIComponent('https://i.ibb.co/p3qm62p/image-2-1.png')}`} />,
  ...
  },
  {
    ...
    logoDirectory: <img alt="Logo" className="hover:opacity-80 transition text-primary h-full object-contain bg-primary p-1" src="/Pantalla.png" />,
  ...
  },
  {
    ...
    logoDirectory: <img alt="The Wedding Planner" className="hover:opacity-80 transition text-primary h-full object-contain p-1" src={`/api/proxy-image?url=${encodeURIComponent('https://www.theweddingplanner.mx/assets/imgs/theweddingplanner.mx-logo.png')}`} />,
