...
export const OFFICIAL_URL = 'https://eventosorganizador.com';
export const OFFICIAL_PREVIEW_URL = 'https://chat.eventosorganizador.com';
export const OFFICIAL_SITE = 'https://eventosorganizador.com';

export const OG_URL = '/og/cover.png?v=1';

export const GITHUB = 'https://github.com/marketingsoluciones/planner-ai';
