...
// Get initial path from URL - solo en cliente para evitar problemas de hidratación
const getInitialPath = () => {
  // En servidor, siempre retornar '/' para consistencia
...
const DiscoverRouter = memo(() => {
  ...
  // ✅ FIX HYDRATION: Usar siempre '/' como valor inicial para consistencia SSR/cliente
  // El UrlSynchronizer se encargará de navegar a la ruta correcta después de la hidratación
  const initialPath = '/';
