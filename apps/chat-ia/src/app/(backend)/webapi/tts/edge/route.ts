 ...
 * (scraping del WebSocket interno de Microsoft Edge browser - frágil).
 * Ahora proxea el payload tal cual a api-ia.
 */
...
export const POST = async (req: Request) => {
  ...
  const upstream = await fetch(`${backendUrl}/webapi/tts/edge`, {
    body,
    headers,
    method: 'POST',
  });
