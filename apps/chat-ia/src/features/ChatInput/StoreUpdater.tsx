...
const StoreUpdater = memo<StoreUpdaterProps>(
  ({
    ...
    useStoreUpdater('sendButtonProps', sendButtonProps ?? undefined);
    useStoreUpdater('onSend', onSend ?? undefined);
    useStoreUpdater('onMarkdownContentChange', onMarkdownContentChange ?? undefined);
