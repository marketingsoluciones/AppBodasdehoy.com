...
import { Infinity, Settings2Icon } from 'lucide-react';
...
const ModelSwitch = memo(() => {
  ...
  // ✅ Mostrar ícono de "Auto" cuando está en modo auto o auto-max, no el modelo real
  const isAutoMode =
    provider === 'auto' || model === 'auto' || provider === 'auto-max' || model === 'auto-max';
      ...
      <ModelSwitchPanel>
        ...
        >
          <div className={styles.icon}>
            {isAutoMode ? (
              <Infinity size={22} style={{ color: '#52c41a' }} />
            ) : (
