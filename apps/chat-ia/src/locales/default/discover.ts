export default {
  ...
  models: {
    ...
    providerInfo: {
      apiTooltip: 'Bodas de Hoy 支持为此提供商使用自定义 API 密钥。',
      input: '输入价格',
      ...
      officialTooltip: 'Bodas de Hoy 官方服务',
      output: '输出价格',
