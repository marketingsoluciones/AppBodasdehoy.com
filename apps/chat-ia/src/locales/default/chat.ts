...
export default {
  ...
  pin: '置顶',
  // Group chat features
  defaultGroupChat: '默认群聊',

  dm: {
    placeholder: '向 {{agentTitle}} 发送私信',
  ...
  group: {
    desc: '与多个助手协作的群聊',
    memberTooltip: '{{count}} 位成员',
    orchestratorThinking: '协调者正在思考...',
    title: '群聊',
  },
  ...
  groupSidebar: {
    members: {
      ...
      orchestratorThinking: '协调者正在思考',
      removeMember: '移除成员',
      stopOrchestrator: '停止协调者',
      triggerOrchestrator: '触发协调者',
    },
    tabs: {
      host: '主机',
      members: '成员',
  ...
  groupWizard: {
    createGroup: '创建群聊',
    existingMembers: '已有成员',
    host: {
      description: '选择用于协调群聊的模型',
      title: '主机模型',
      tooltip: '主机模型负责协调群聊中的对话',
    },
    memberCount: '{{count}} 位成员',
    noMatchingTemplates: '没有匹配的模板',
    noTemplateMembers: '该模板没有成员',
    noTemplates: '没有可用的模板',
    title: '创建群聊',
    useTemplate: '使用模板',
  },
  ...
  memberSelection: {
    ...
    allMembers: '所有成员',
    createGroup: '创建群聊',
    noSelectedAgents: '请选择至少一个助手',
    searchAgents: '搜索助手...',
    setInitialMembers: '设置初始成员',
  },
  ...
  shareModal: {
    ...
    includeUser: '包含用户消息',
    pdf: 'PDF',
    pdfErrorDescription: 'PDF 生成失败，请重试',
    pdfGenerationError: 'PDF 生成错误',
    screenshot: '截图',
    settings: '导出设置',
    text: '文本',
