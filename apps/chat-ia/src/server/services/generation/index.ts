...
import { parseDataUri } from '@lobechat/utils';
import debug from 'debug';
import { sha256 } from 'js-sha256';
import mime from 'mime';
import { IMAGE_GENERATION_CONFIG } from 'model-bank';
import { nanoid } from 'nanoid';
// Sharp se importa dinámicamente para evitar errores en Vercel ARM64 cuando no está disponible
...
// Lazy-load sharp para evitar errores de compatibilidad ARM64 en Vercel
