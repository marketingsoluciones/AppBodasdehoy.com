...
export const useClientDataSWR: SWRHook = (key, fetch, config) =>
  useSWR(key, fetch, {
    // ✅ OPTIMIZACIÓN: Deduplicar llamadas durante 500ms para evitar fetches duplicados
    // en la carga inicial sin afectar la experiencia de usuario en switches rápidos
