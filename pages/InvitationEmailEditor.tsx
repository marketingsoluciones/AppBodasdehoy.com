...
const InvitationEmailEditor = (props) => {
    ...
    return (
        <div className='relatve h-full px-3  space-y-2'>
            <BlockTitle title={"Diseña tu Invitacion"} />
            {editorReady && <div className='absolute left-[12px] top-[200px] flex gap-2 '>
                <div
                    onClick={() => router.push('/invitaciones')}
                    className={"   flex items-center justify-center cursor-pointer w-16 border-x  bg-[#F4F4F4]"}
                >
                ...
                <div
                    onClick={() => saveDesign()}
                    className={"  flex flex-col items-center justify-center cursor-pointer w-16 border-x  bg-[#F4F4F4]"}
                >
                    <div className='pt-[2px]'>
            ...
            <EmailEditor ref={emailEditorRef} onReady={onReady} minHeight={'90%'} />
        </div>
    );
};
