...
const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    if (isMounted) {
      ...
      /*--------------------------------------------------------------------*/
      const devDomain = ["bodasdehoy", "eventosplanificador", "eventosorganizador", "vivetuboda", "champagne-events", "annloevents", "miamorcitocorazon", "eventosintegrados", "ohmaratilano"]
